...
// v1 host UI (opencode 1.x). Imports bare "solid-js" — the specifier the v1
// host rewrites to its own live solid runtime. Never loaded by the v2 host.
...
// The pending-file loop is shared; only these two renderers are v1-specific.
